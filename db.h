...
#define REQUIRE_VERSION 70002 // thachpv mod

static inline int GetRequireHeight(const bool testnet = fTestNet)
{
    return testnet ? 700000 : 840000; // thachpv note: need modify
}
...
public:
  ...
  */
  int GetBanTime() const {
    if (IsGood()) return 0;
    if (clientVersion && clientVersion < 50000) { return 604800; } //thachpv note: need modify, 
